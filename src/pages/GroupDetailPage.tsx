        ...
        <AuthGate>
            <div className="group-detail page-container">
                <header className="group-detail__header">
                    ...
                    <Link className="button button--primary" to={`/rooms/create?group=${id}`}>
                        그룹에서 모집하기
                    </Link>
                </header>
                <nav className="group-tabs" aria-label="그룹 메뉴">
                    {(
                        [
                            ['rooms', '모집방', `/groups/${id}`],
                        ...
                        <Link className={tab === value ? 'is-active' : ''} key={value} to={to}>
                            {label}
                        </Link>
                    ))}
                </nav>
                ...
                {tab === 'members' && (
                    <section className="tab-content">
                        <div className="section-heading">
                            ...
                            <span className="count-label">{members.length}명</span>
                        </div>
                        {members.length ? (
                            <div className="member-table">
                                ...
                                {members.map((member) => (
                                    <div className="member-table__row" key={member.id}>
                                        <div>
                ...
                {tab === 'roles' && (
                    <section className="tab-content role-layout">
                        <div>
                            <div className="section-heading">
                                <div>
                                    <h2>역할</h2>
                                    ...
                                    {roles.map((role) => (
                                        <div className="role-row" key={role.id}>
                                            ...
                                            <div>
                                                ...
                                                <button className="danger-link" onClick={() => void removeRole(role)}>
                                                    삭제
                                                </button>
                                            </div>
                                        </div>
                ...
                {tab === 'settings' && (
                    <section className="tab-content settings-stack">
