    ...
    return (
        <div className="rooms-page page-container">
            <section className="explorer-heading">
                ...
                <Link className="button button--primary" to="/rooms/create">
                    새 모집 만들기
                </Link>
            </section>
            ...
            <div className="explorer-grid">
                <section className="room-board" aria-label="모집방 목록">
                    ...
                    {loading || loadingGroups ? (
                        ...
                        <InlineNotice tone="error" title="모집방을 불러오지 못했어요">
                            {error}
                            <br />
                            <button className="inline-action" onClick={() => void loadRooms()}>
                                다시 시도
                            </button>
                        </InlineNotice>
                    ) : !activeGroup ? (
                ...
                <aside className="group-rail" aria-label="내 그룹">
                    <div className="group-rail__heading">
                        <div>
                            <h2>그룹</h2>
                    ...
                    {groups.length ? (
                        ...
                        <div className="compact-empty">
                            <p>아직 그룹이 없어요.</p>
                            <Link className="text-link" to="/groups/create">
                                첫 그룹 만들기
                            </Link>
                        </div>
                    )}
                    {activeGroup && (
                        <div className="group-brief">
                            ...
                            <Link className="text-link" to={`/groups/${activeGroup.id}`}>
                                그룹 관리
                            </Link>
                        </div>
                    )}
