  ...
  return <AuthGate><div className="room-detail page-container">
    ...
    <div className="room-detail__grid">
      <section className="detail-main">
        ...
        <section className="detail-section"><h2>모집 조건</h2><dl className="condition-list"><div><dt>게임</dt><dd>{room.game_name}</dd></div><div><dt>목표 인원</dt><dd>{room.target_count}{room.unit_type}</dd></div><div><dt>필요 포지션</dt><dd>{room.target_role ? <RoleBadge name={room.target_role} color="#ef6a42" /> : '포지션 무관'}</dd></div><div><dt>방장</dt><dd>{host?.name ?? room.host_id}</dd></div></dl></section>
