...
const paths: Record<IconName, React.ReactNode> = {
    ...
    game: (
        <>
            <path d="M6 10h12a4 4 0 0 1 3.6 5.7l-1.3 2.6a2 2 0 0 1-3.1.6L14.5 17h-5l-2.7 1.9a2 2 0 0 1-3.1-.6l-1.3-2.6A4 4 0 0 1 6 10Z" />
            <path d="M8 13v4M6 15h4M17 14h.01M19 16h.01" />
            <path d="M8 10 9 7h6l1 3" />
        </>
    ),
    group: (
        <>
    ...
    sport: (
        <>
            ...
            <path d="m8 4 4 3 4-3M4 10l4 2-1 5M20 10l-4 2 1 5M9 21l3-4 3 4" />
            <path d="m8 12 4-5 4 5-1 5H9Z" />
        </>
    ),
    user: (
        <>
